...
import { ContractAbi } from '../contract-info/rmrk_proxy';
import QueryMethods from '../query/rmrk_proxy';
import BuildExtrinsicMethods from '../build-extrinsic/rmrk_proxy';
import TxSignAndSendMethods from '../tx-sign-and-send/rmrk_proxy';
import MixedMethods from '../mixed-methods/rmrk_proxy';
import EventsClass from '../events/rmrk_proxy';
