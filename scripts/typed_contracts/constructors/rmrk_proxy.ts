...
import { ContractFile } from '../contract-info/rmrk_proxy';
	...
	*/
   	async "new" (
		...
		const storageDepositLimit = __options?.storageDepositLimit;
			const tx = code.tx["new"]!({ gasLimit, storageDepositLimit, value: __options?.value }, rmrkContract, catalogContract, mintPrice);
			let response;
