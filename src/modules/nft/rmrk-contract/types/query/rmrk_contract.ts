...
export default class Methods {
  ...
  totalSupply(
    ...
    return queryOkJSON(
      ...
      __options,
      (result) => {
        return handleReturnType(result, getTypeDescription(25, 'rmrk_contract'));
      }
    );
  }
  ...
  'mintingLazy::tokenUri'(
    ...
    return queryOkJSON(
      ...
      __options,
      (result) => {
        return handleReturnType(result, getTypeDescription(35, 'rmrk_contract'));
      }
    );
  }
  ...
  > {
    return queryOkJSON(
      ...
      __options,
      (result) => {
        return handleReturnType(result, getTypeDescription(45, 'rmrk_contract'));
      }
    );
  }
  ...
  getBaseMetadata(
    ...
    return queryOkJSON(
      ...
      __options,
      (result) => {
        return handleReturnType(result, getTypeDescription(61, 'rmrk_contract'));
      }
    );
  }
