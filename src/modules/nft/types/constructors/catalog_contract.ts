...
export default class Constructors {
   ...
   */
  async new(catalogMetadata: Array<number | string | BN>, __options?: ConstructorOptions) {
    const __contract = JSON.parse(
      Files.readFileSync('./src/modules/nft/contracts/catalog_contract.contract').toString()
    );
