...
export default class Methods {
  ...
  approve(
    ...
    return queryOkJSON(
      ...
      __options,
      (result) => {
        return handleReturnType(result, getTypeDescription(19, 'rmrk_example_equippable_lazy'));
      }
    );
  }
  ...
  > {
    return queryOkJSON(
      ...
      __options,
      (result) => {
        return handleReturnType(result, getTypeDescription(27, 'rmrk_example_equippable_lazy'));
      }
    );
  }
  ...
  mintMany(
    ...
    return queryOkJSON(
      ...
      __options,
      (result) => {
        return handleReturnType(result, getTypeDescription(41, 'rmrk_example_equippable_lazy'));
      }
    );
  }
