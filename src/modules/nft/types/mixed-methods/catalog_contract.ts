...
export default class Methods {
  ...
  addEquippableAddresses(
    ...
    return txSignAndSend(
      ...
      this.__keyringPair,
      'catalog::addEquippableAddresses',
      (events: EventRecord) => {
  ...
  getPart(
    ...
    return queryOkJSON(
      ...
      __options,
      (result) => {
        return handleReturnType(result, getTypeDescription(18, 'catalog_contract'));
      }
    );
  }
  ...
  isEquippableByAll(
    ...
    return queryOkJSON(
      ...
      this.__nativeContract,
      this.__callerAddress,
      'catalog::isEquippableByAll',
      [partId],
      __options,
      (result) => {
        return handleReturnType(result, getTypeDescription(22, 'catalog_contract'));
      }
    );
  }
  ...
  resetEquippableAddresses(partId: number | string | BN, __options: GasLimit) {
    return txSignAndSend(
      ...
      this.__nativeContract,
      this.__keyringPair,
      'catalog::resetEquippableAddresses',
      (events: EventRecord) => {
        return decodeEvents(events, this.__nativeContract, 'catalog_contract');
      },
      [partId],
  ...
  getPartsCount(
    ...
    return queryOkJSON(
      ...
      this.__nativeContract,
      this.__callerAddress,
      'catalog::getPartsCount',
      [],
      __options,
      (result) => {
        return handleReturnType(result, getTypeDescription(24, 'catalog_contract'));
      }
    );
  }
  ...
  ensureEquippable(
    ...
    return queryOkJSON(
      ...
      this.__nativeContract,
      this.__callerAddress,
      'catalog::ensureEquippable',
      [partId, targetAddress],
      __options,
      (result) => {
        return handleReturnType(result, getTypeDescription(11, 'catalog_contract'));
      }
    );
  }
  ...
  getCatalogMetadata(
    ...
    return queryOkJSON(
      ...
      __options,
      (result) => {
        return handleReturnType(result, getTypeDescription(25, 'catalog_contract'));
      }
    );
  }
   ...
   * @returns { void }
   */
  setupCatalog(catalogMetadata: Array<number | string | BN>, __options: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
