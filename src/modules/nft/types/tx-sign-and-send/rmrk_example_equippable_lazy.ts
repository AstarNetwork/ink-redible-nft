...
export default class Methods {
   ...
   * @param { (number | string | BN) } assetId,
   */
  getAssetCatalogAddress(assetId: number | string | BN, __options?: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
   ...
   * @param { (number | string | BN) } assetId,
   */
  'query::getAsset'(assetId: number | string | BN, __options?: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
   ...
   */
  getAssets(assetIds: Array<number | string | BN>, __options?: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
   ...
   * @param { ArgumentTypes.Id } id,
   */
  getToken(id: ArgumentTypes.Id, __options?: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
