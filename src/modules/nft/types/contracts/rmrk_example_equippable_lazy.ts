...
import ABI from '../../contracts/rmrk_example_equippable_lazy.json';
import QueryMethods from '../query/rmrk_example_equippable_lazy';
import BuildExtrinsicMethods from '../build-extrinsic/rmrk_example_equippable_lazy';
import TxSignAndSendMethods from '../tx-sign-and-send/rmrk_example_equippable_lazy';
import MixedMethods from '../mixed-methods/rmrk_example_equippable_lazy';
import EventsClass from '../events/rmrk_example_equippable_lazy';
...
export default class Contract {
  ...
  /**
	...
	*/
  constructor(address: string, calledAddress: string, nativeAPI: ApiPromise) {
    this.address = address;
    this.nativeContract = new ContractPromise(nativeAPI, ABI, address);
    this.nativeAPI = nativeAPI;
    this.contractAbi = new Abi(ABI);

    this.query = new QueryMethods(this.nativeContract, this.nativeAPI, calledAddress);
