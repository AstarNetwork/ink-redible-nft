...
import ABI from '../../contracts/catalog_contract.json';
...
export default class Contract {
  ...
  /**
	...
	*/
  constructor(address: string, callerAddress: string, nativeAPI: ApiPromise) {
    this.address = address;
    this.nativeContract = new ContractPromise(nativeAPI, ABI, address);
    this.nativeAPI = nativeAPI;
    this.contractAbi = new Abi(ABI);

    this.query = new QueryMethods(this.nativeContract, this.nativeAPI, callerAddress);
